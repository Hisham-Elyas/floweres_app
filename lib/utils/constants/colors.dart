...
class HColors {
  // App theme colors
  static const Color primary = Color(0xFFae614d);
  static const Color secondary = Color(0xFFf0e1cc);
  static const Color accent = Color(0xFFf0e5d6);
  ...
  static const Color buttonPrimary = Color(0xFFae614d);
